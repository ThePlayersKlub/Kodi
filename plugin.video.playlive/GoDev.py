...
import maintenance
AddonID = 'plugin.video.playlive'
AddonTitle = 'Players Klub'
Images=xbmc.translatePath(os.path.join('special://home','addons',AddonID,'resources/art/'));
fanart = Images+'fanart.jpg'
icon = Images+'icon.png'
FabAddon = xbmcaddon.Addon('plugin.video.playlive')
ADDON=xbmcaddon.Addon(id='plugin.video.playlive')
dialog       =  xbmcgui.Dialog()
dialogprocess =  xbmcgui.DialogProgress()
USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata/',''))
FabData      =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.playlive/',''))
...
def SpeedChoice():
	...
	if choice == 0:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.playlive/speedtest.py")')
	if choice == 1:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.playlive/fastload.py")')
